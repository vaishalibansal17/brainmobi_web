...
!function(a) {
    ...
    c.VERSION = "3.3.7", c.TRANSITION_DURATION = 150, c.prototype.close = function(b) {
        ...
        b.isDefaultPrevented() || (g.removeClass("in"), a.support.transition && g.hasClass("fade") ? g.one("bsTransitionEnd", d).emulateTransitionEnd(c.TRANSITION_DURATION) : d());
    };
    var d = a.fn.alert;
    ...
    var c = function(b, c) {
        ...
        "" == this.options.pause && !("ontouchstart" in document.documentElement) && this.$element.on("mouseenter.bs.carousel", a.proxy(this.pause, this)).on("mouseleave.bs.carousel", a.proxy(this.cycle, this));
    };
    c.VERSION = "3.3.7", c.TRANSITION_DURATION = 600, c.DEFAULTS = {
        ...
        var d = (c + ("prev" == a ? -1 : 1)) % this.$items.length;
    ...
    a.fn.collapse = c, a.fn.collapse.Constructor = d, a.fn.collapse.noConflict = function() {
        ...
        var f = b(e), g = f.data("bs.collapse") ? "toggle" : e.data();
        c.call(f, g);
    });
}(jQuery), function(a) {
    "use strict";
    ...
    function c(c) {
        c && 3 === c.which || (a(".dropdown-backdrop").remove(), a(d).each(function() {
    ...
    e.VERSION = "3.3.7", e.prototype.toggle = function(d) {
        var e = a(this);
        ...
        if (/(38|40|27|32)/.test(c.which) && !/input|textarea/i.test(c.target.tagName)) {
            ...
            if (c.preventDefault(), c.stopPropagation(), !e.is(".disabled, :disabled")) {
                var f = b(e), g = f.hasClass("open");
                if (!g && 27 != c.which || g && 27 == c.which) return 27 == c.which && f.find(d).trigger("focus"), 
                e.trigger("click");
                var h = f.find(".dropdown-menu li:not(.disabled):visible a");
                if (h.length) {
                    var i = h.index(c.target);
                    38 == c.which && 0 < i && i--, 40 == c.which && i < h.length - 1 && i++, ~i || (i = 0), 
    ...
    a.fn.dropdown = function(b) {
        return this.each(function() {
            ...
            d || c.data("bs.dropdown", d = new e(this)), "string" == typeof b && d[b].call(c);
        });
    }, a.fn.dropdown.Constructor = e, a.fn.dropdown.noConflict = function() {
        return a.fn.dropdown = f, this;
    }, a(document).on("click.bs.dropdown.data-api", c).on("click.bs.dropdown.data-api", ".dropdown form", function(a) {
        a.stopPropagation();
    }).on("click.bs.dropdown.data-api", d, e.prototype.toggle).on("keydown.bs.dropdown.data-api", d, e.prototype.keydown).on("keydown.bs.dropdown.data-api", ".dropdown-menu", e.prototype.keydown);
}(jQuery), function(a) {
    "use strict";
    function b(b, d) {
        return this.each(function() {
    ...
    b.VERSION = "3.3.7", b.TRANSITION_DURATION = 150, b.DEFAULTS = {
        ...
        a.support.transition && f.hasClass("fade") ? f.one("bsTransitionEnd", d).emulateTransitionEnd(b.TRANSITION_DURATION) : d(), 
    ...
    a.fn.tooltip = function(c) {
        return this.each(function() {
            ...
            !e && /destroy|hide/.test(c) || (e || d.data("bs.tooltip", e = new b(this, f)), 
            "string" == typeof c && e[c]());
        });
    ...
    a.fn.popover = function(c) {
        return this.each(function() {
            ...
            !e && /destroy|hide/.test(c) || (e || d.data("bs.popover", e = new b(this, f)), 
            "string" == typeof c && e[c]());
        });
